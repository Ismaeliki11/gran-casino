    ...
    return (
        <div className="absolute inset-0 z-0 overflow-hidden">
            <AnimatePresence mode="wait" initial={false}>
                ...
                >
                    <div className="absolute inset-0 bg-black-primary/40 z-10" />
                    <Image
            ...
            {/* Premium Vignetado y Gradientes */}
            <div className="absolute inset-0 bg-gradient-to-t from-black-primary via-transparent to-black-primary/80 z-20" />
            <div className="absolute inset-0 bg-gradient-to-r from-black-primary/40 via-transparent to-black-primary/40 z-20" />
