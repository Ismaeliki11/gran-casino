        ...
        <main className="bg-black-primary text-crema min-h-screen">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0">
                    <div className="absolute inset-0 bg-black-primary/60 z-10" />
                    <div className="absolute inset-0 bg-gradient-to-b from-black-primary/80 via-transparent to-black-primary z-10" />
                    <Image
